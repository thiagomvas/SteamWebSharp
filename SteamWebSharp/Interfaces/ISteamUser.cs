...
{
    /// <summary>
    /// Resolves a Steam vanity URL (custom user profile URL) to a Steam ID.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves the player bans for a given Steam user.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves the player bans for a list of Steam users.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves the friend list for a given Steam user.
    /// </summary>
    /// <param name="steamId">The Steam ID of the user.</param>
    ...
    /// <summary>
    /// Retrieves the user groups for a given Steam user.
    /// </summary>
    /// <param name="steamId">The Steam ID of the user.</param>
    ...
    /// <summary>
    /// Retrieves the player summary for a given Steam user.
    /// </summary>
    /// <param name="steamId">The Steam ID of the user.</param>
    ...
    /// <summary>
    /// Retrieves the player summaries for a list of Steam users.
    /// </summary>
    /// <param name="steamIds">The Steam IDs of the users.</param>
