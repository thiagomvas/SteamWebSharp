...
public interface ISteamUser
{
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains a <see cref="PlayerBans" /> object
    ///     with ban details.
    /// </returns>
    ...
    ///     <see cref="PlayerBans" /> objects, one for each user.
    /// </returns>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains an enumerable collection of
    ///     <see cref="Friend" /> objects representing the user's friends.
    /// </returns>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains an enumerable collection of
    ///     <see cref="Group" /> objects representing the groups the user is a member of.
    /// </returns>
    ...
    /// <param name="steamId">The Steam ID of the user.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains a <see cref="PlayerSummary" />
    ///     object with the user's profile and other details.
    /// </returns>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains an enumerable collection of
    ///     <see cref="PlayerSummary" /> objects, one for each user.
    /// </returns>
